...
--
-- Anamakine: localhost
-- Üretim Zamanı: 19 Kas 2023, 12:43:26
...
CREATE TABLE `guest` (
  ...
  `guest_fullname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `national_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `guest_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `guest_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(7, 3, 'Ahmet', '123', '111111111', 'ahmet@mail.com'),
(8, 3, 'Batuhan', '234', '2222222222', 'batuhan@mail.com'),
(9, 3, 'Zeynep', '345', '', 'zeynep@mail.com'),
(10, 4, 'Jhon Wick', '11111111111', '11111111111', 'wick@gmail.com'),
(11, 5, 'Ariana', '1111111111', '2222222222', 'ari@gmail.com');
...
CREATE TABLE `hotel` (
  ...
  `hotel_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `parking` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `wifi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `pool` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `gym` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `concierge` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `spa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `room_service` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Hilton İstanbul Bosphorus', 'İstanbul', 'Sisli', '5', 'Harbiye, Cumhuriyet Cd. No:50, 34367', 'hilton@otel.com', '02122022222', 'Yes', 'Yes', 'No', 'Yes', 'Yes', 'Yes', 'Yes'),
(2, 'Hotel Raffles Istanbul', 'İstanbul', 'Beşiktaş', '5', 'Levazım, Zorlu Center, Koru Sok., 34340', 'raffles@otel.com', '02122022222', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Yes'),
(3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Meltem, Sakıp Sabancı Blv., 07030 Muratpaşa', 'rixos@otel.com', '02422422424', 'No', 'No', 'Yes', 'No', 'Yes', 'No', 'Yes');
...
CREATE TABLE `period_type` (
  `id` int NOT NULL,
  `period_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(4, 2, 'Hotel Raffles Istanbul\r\n', 'Single', 'Off Season', 'İstanbul', 1, '2023-10-02', '2023-10-05', 3, 300),
(5, 3, 'Rixos Downtown Antalya\r\n', 'Single', 'Season', 'Antalya', 1, '2023-04-01', '2023-05-01', 30, 3000);
...
(1, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Season', '2023-06-01', '2023-09-01', 'Single', 15),
(2, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Off Season', '2023-09-02', '2024-05-31', 'Single', 5),
(3, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Season', '2023-06-01', '2023-09-01', 'Double', 20),
(4, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Off Season', '2023-09-02', '2024-05-31', 'Double', 10),
(5, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Season', '2023-06-01', '2023-09-01', 'King Suite', 5),
(6, 1, 'Hilton İstanbul Bosphorus\r\n', 'İstanbul', 'Sisli', '5', 'Off Season', '2023-09-02', '2024-05-31', 'King Suite', 3),
(7, 2, 'Hotel Raffles Istanbul\r\n', 'İstanbul', 'Beşiktaş', '5', 'Season', '2023-05-31', '2023-10-01', 'Single', 50),
(8, 2, 'Hotel Raffles Istanbul\r\n', 'İstanbul', 'Beşiktaş', '5', 'Off Season', '2023-10-02', '2024-05-31', 'Single', 9),
(9, 2, 'Hotel Raffles Istanbul\r\n', 'İstanbul', 'Beşiktaş', '5', 'Season', '2023-05-31', '2023-10-01', 'Double', 35),
(10, 2, 'Hotel Raffles Istanbul\r\n', 'İstanbul', 'Beşiktaş', '5', 'Off Season', '2023-10-02', '2024-05-31', 'Double', 7),
(11, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Season', '2023-04-01', '2023-10-01', 'Double', 10),
(12, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Off Season', '2023-10-02', '2024-03-31', 'Double', 3),
(13, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Season', '2023-04-01', '2023-10-01', 'King Suite', 3),
(14, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Off Season', '2023-10-02', '2024-03-31', 'King Suite', 2),
(15, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Season', '2023-04-01', '2023-10-01', 'Single', 14),
(16, 3, 'Rixos Downtown Antalya\r\n', 'Antalya', 'Muratpasa', '4', 'Off Season', '2023-10-02', '2024-03-31', 'Single', 5);
...
(1, 'Berat Agun', 'admin1', '1234', 'admin'),
